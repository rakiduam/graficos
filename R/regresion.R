...
# if the following line and the line containing "dev.off()" are executed, the
# plot will be saved as a png file in the current working directory
# png("Presidental.png", width = 18, height = 18, units = "cm", res = 800,
# pointsize = 10)
...
#aqui necesita la libreria de plotrix
